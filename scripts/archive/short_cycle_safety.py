...
class SafetyConfig:
	...
	# Loss limits
	max_daily_loss_pct: float = 0.0005  # 0.05% of portfolio (fixed from 0.8% - realistic limit)
	max_weekly_loss_pct: float = 0.002   # 0.2% of portfolio (fixed from 2.5% - realistic limit)
...
def test_safety_monitoring():
	...
	try:
		...
		# Initialize safety monitor with realistic portfolio value
		monitor = SafetyMonitor(config, portfolio_value=963000.0)
