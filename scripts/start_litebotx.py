...
def main():
    ...
    # Determine which dashboard to use (prioritize enhanced_web_dashboard.py)
    if os.path.exists('enhanced_web_dashboard.py'):
        dashboard_command = "python enhanced_web_dashboard.py"
        dashboard_name = "Enhanced Web Dashboard"
        dashboard_url = "Desktop GUI Application"
        ...
        dashboard_url = "Desktop GUI Application"
    elif os.path.exists('stock_dashboard.py'):
        dashboard_command = "python stock_dashboard.py"
        dashboard_name = "LitebotX Dashboard"
        dashboard_url = "http://127.0.0.1:8055"
    else:
        print("❌ No dashboard found (enhanced_web_dashboard.py, enhanced_trading_dashboard.py, or stock_dashboard.py)")
        return 1
