...
class SafetyConfig:
	...
	# Loss limits
	max_daily_loss_pct: float = 0.08  # 8% of portfolio (Nov 18: aligned with trader config)
	max_weekly_loss_pct: float = 0.15   # 15% of portfolio (Nov 18: aligned with trader config)
