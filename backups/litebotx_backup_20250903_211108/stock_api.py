...
class StockAPIManager:
    ...
    def setup_alpaca(self):
        ...
        try:
            # Use same method as RealPaperTradingEngine
            ...
            if api_key and secret_key:
                ...
                logger.info(f"✅ Alpaca API connected successfully - Key: {api_key[:8]}***")
            else:
                logger.warning("⚠️ Alpaca API credentials not found in environment")
