...
class ShortCycleConfig:
    ...
    confidence_threshold: float = 0.50  # Lowered threshold from 0.55 to capture more signals (like TSLA @0.45)
        ...
        try:
            ...
            if os.path.exists(positions_file):
                ...
                for data in position_data:
                    ...
                    position.entry_date = dt.datetime.fromisoformat(data['entry_date']).date()
                    position.exit_date = dt.datetime.fromisoformat(data['exit_date']).date()
        ...
        try:
            ...
            for position in self.positions:
                data = {
                    ...
                    'time_horizon_days': position.time_horizon_days,
