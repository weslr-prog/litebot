...
class RegimeAwareController:
    ...
    def __init__(self):
        ...
        self.regime_config = RegimeConfig(
            ...
            max_positions={
                'UP_LOWVOL': 15,       # More diversification in good times
                'bull': 12,            # Moderate diversification
                'UP_HIGHVOL': 10,      # Focus on best ideas
                'sideways': 8,         # Concentrated in chop
                'volatile': 6,         # Very concentrated
                'DOWN_LOWVOL': 4,      # Minimal positions
                'bear': 3,             # Only best ideas
                'DOWN_HIGHVOL': 1      # Single position or cash
            }
        )
