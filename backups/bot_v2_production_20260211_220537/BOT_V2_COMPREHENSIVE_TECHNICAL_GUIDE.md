...
### Combined Monthly Target
```
Gap & Go:     +12% monthly on 70% capital allocation
Fade/Short:   +5% monthly on 15% capital allocation
Momentum:     +7% monthly on 15% capital allocation

Weighted average:
= (0.12 × 0.70) + (0.05 × 0.15) + (0.07 × 0.15)
= 0.084 + 0.0075 + 0.0105
= 10.2% per month

Or approximately 5% weekly

Annual projection: ~125% return
$1,000 starting → ~$2,250 by year-end
(Conservative due to compounding and drawdowns)
```
