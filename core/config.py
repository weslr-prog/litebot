...
class Sprint1Config:
    ...
    # Intraday analysis config
    enable_intraday_analysis: bool = True  # Default: enabled for production
    max_intraday_analyses_per_day: int = 50  # API safety limit
...
class Config:
    ...
    def __init__(self):
        ...
        self.ENABLE_INTRADAY_ANALYSIS = config.enable_intraday_analysis
        self.MAX_INTRADAY_ANALYSES_PER_DAY = config.max_intraday_analyses_per_day
